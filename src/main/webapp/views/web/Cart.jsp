											...
											<c:if test="${o.productID == p.id}">
												<tr>
													...
													<td class="align-middle"><strong
														...
														<td class="align-middle"><strong
															style="font-size: 15px"><c:out value="${o.size}" /></strong></td>

													<td class="align-middle"><a
														href="subAmountCart?productID=${o.productID}&amount=${o.amount}&size=<c:out value='${o.size}' />"
													...
													<td class="align-middle"><a
														href="deleteCart?productID=${o.productID }&size=<c:out value='${o.size}' />"
														class="text-dark">
