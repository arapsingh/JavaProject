						...
						<div>
							...
							<div class="md-form md-outline">
								<label for="form76" style="font-size: 15px">Thêm bình
									...
									<textarea id="form76" class="md-textarea form-control pr-6" rows="4" style="font-size: 15px; text-transform: none;"><c:out value="${userInput}" /></textarea>
							</div>
						...
						<c:forEach items="${listAllReview}" var="r">
							<div class="media mt-3 mb-4">
								...
								<div class="media-body">
									...
									<p class="mb-0" style="text-transform: none;"><c:out value="${r.contentReview}" /></p>
