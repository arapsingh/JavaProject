...
public class LoginControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (a == null) {
			...
			String uCookieString = u.getName() + "=" + u.getValue() + "; SameSite=Strict; HttpOnly";
			String pCookieString = p.getName() + "=" + p.getValue() + "; SameSite=Strict; HttpOnly";

			response.setHeader("Set-Cookie", uCookieString);
			response.addHeader("Set-Cookie", pCookieString);
